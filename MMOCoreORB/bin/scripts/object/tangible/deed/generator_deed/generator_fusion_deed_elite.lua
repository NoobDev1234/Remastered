...
object_tangible_deed_generator_deed_generator_fusion_deed_elite = object_tangible_deed_generator_deed_shared_generator_fusion_deed_elite:new {
	...
	generatedObjectTemplate = "object/installation/generators/power_generator_fusion_elite.iff",
	...
	experimentalMin = {0, 0, 12, 350000, 1000},
	experimentalMax = {0, 0, 24, 450000, 1000},
